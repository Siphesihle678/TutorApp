...
from app.routes import auth, quiz, assignment, announcement, dashboard, ai_features
...
app.include_router(ai_features.router, prefix="/api/ai", tags=["AI Teacher Tools"])
